...
function _action_xs_hook_css() {
    if (defined('FW')) {
        ...
        $hero_heading = clemo_get_option('general_posts_header');
        ...
        $blog_hero = $hero_heading['header_image'] != '' ? $hero_heading['header_image']['url'] : CLEMO_IMAGES . '/exman.jpg';
        $page_hero = '';
        ...
        $custom_css = clemo_get_option('custom_css');
