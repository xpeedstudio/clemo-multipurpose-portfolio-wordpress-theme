...
class Wellnesscenter_Option_Type_Table extends FW_Option_Type
{
	...
	protected function _render( $id, $option, $data ) {
		...
		if ( ! $table_shortcode ) {
			trigger_error(
				__( 'table-builder option type must be inside the table shortcode', 'clemo' ),
				E_USER_ERROR
			);
		}
	...
	protected function _get_defaults() {
		return array(
			'header_options'  => array(
				'table_purpose' => array(
					'type'    => 'select',
					'label'   => __( 'Table Styling', 'clemo' ),
					'desc'    => __( 'Choose the table styling options', 'clemo' ),
					'choices' => array(
						'pricing' => __( 'Use the table as a pricing table', 'clemo' ),
						'tabular' => __( 'Use the table to display tabular data', 'clemo' ),
					),
					'value'   => 'pricing',
					'attr'    => array(
			...
			'row_options'     => array(
				'name' => array(
					...
					'desc'    => false,
					'choices' => array(
						'default-row' => __( 'Default row', 'clemo' ),
						'heading-row' => __( 'Heading row', 'clemo' ),
						'pricing-row' => __( 'Pricing row', 'clemo' ),
						'button-row'  => __( 'Button row', 'clemo' ),
						'switch-row'  => __( 'Modal button row', 'clemo' )
					),
				)
			),
			'columns_options' => array(
				'name' => array(
					...
					'desc'    => false,
					'choices' => array(
						'default-col'   => __( 'Default column', 'clemo' ),
						'highlight-col' => __( 'Highlight column', 'clemo' ),
					),
				)
			),
			'content_options' => array(
				...
				'switch-row' => array(
					'button_text' => array(
						...
						'desc'  => false,
						'attr' => array(
							'placeholder' => __('button text', 'clemo')
						),
					),
				),
				'heading-row' => array(
					...
					'sub_heading' => array(
						...
						'desc'  => false,
						'attr' => array(
							'placeholder' => __('sub title (can be left blank)', 'clemo')
						),
					),
				),
				'pricing-row' => array(
